...
if not args['template_task_id']:
    args['template_task_id'] = Task.get_task(
        project_name='tensorboard_test', task_name='Keras HP optimization base').id
...
an_optimizer = HyperParameterOptimizer(
    ...
    hyper_parameters=[
        UniformIntegerParameterRange('General/layer_1', min_value=10, max_value=20, step_size=1),
        UniformIntegerParameterRange('General/layer_2', min_value=10, max_value=20, step_size=1),
        DiscreteParameterRange('General/batch_size', values=[10, 12, 15]),
        DiscreteParameterRange('General/epochs', values=[3]),
    ],
